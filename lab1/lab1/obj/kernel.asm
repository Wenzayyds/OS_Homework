...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200460:	02f70563          	beq	a4,a5,8020048a <interrupt_handler+0xbe>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200474:	86850513          	addi	a0,a0,-1944 # 80200cd8 <etext+0x262>
    80200478:	bfbff0ef          	jal	ra,80200072 <cprintf>
             	num+=1;
    ...
    80200488:	bfd1                	j	8020045c <interrupt_handler+0x90>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    802004e2:	71250513          	addi	a0,a0,1810 # 80200bf0 <etext+0x17a>
    802004e6:	b8dff0ef          	jal	ra,80200072 <cprintf>
             tf->epc+=2;
    ...
    80200504:	71850513          	addi	a0,a0,1816 # 80200c18 <etext+0x1a2>
    80200508:	b6bff0ef          	jal	ra,80200072 <cprintf>
            cprintf("Exception Type:breakpoint\n");
    8020050c:	00000517          	auipc	a0,0x0
    80200510:	72c50513          	addi	a0,a0,1836 # 80200c38 <etext+0x1c2>
    80200514:	b5fff0ef          	jal	ra,80200072 <cprintf>
            tf->epc+=2;
    80200518:	10843783          	ld	a5,264(s0)
}
    8020051c:	60a2                	ld	ra,8(sp)
            tf->epc+=2;
    8020051e:	0789                	addi	a5,a5,2
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    80200532:	f63ff06f          	j	80200494 <exception_handler>
        interrupt_handler(tf);
    80200536:	e97ff06f          	j	802003cc <interrupt_handler>
	...
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200634:	be078793          	addi	a5,a5,-1056 # 80201210 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200688:	9f8a0a13          	addi	s4,s4,-1544 # 8020107c <etext+0x606>
    ...
    80200694:	b48c0c13          	addi	s8,s8,-1208 # 802011d8 <error_string>
    ...
    80200782:	b4260613          	addi	a2,a2,-1214 # 802012c0 <error_string+0xe8>
    ...
    80200916:	99e60613          	addi	a2,a2,-1634 # 802012b0 <error_string+0xd8>
    ...
    80200928:	98460613          	addi	a2,a2,-1660 # 802012a8 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    8020092c:	00001417          	auipc	s0,0x1
    80200930:	97d40413          	addi	s0,s0,-1667 # 802012a9 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009bc:	8f140413          	addi	s0,s0,-1807 # 802012a9 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
